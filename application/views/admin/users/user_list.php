  ...
  <section class="content">
    ...
    <div class="card-header">
        ...
        <div class="box-tools pull-right">
            <a href="<?= base_url('admin/users/add'); ?>" class="btn btn-primary btn-sm">ADD NEW</a>
        </div>
    </div>
    ...
    <div class="fileimport">
        <div class="form-group">
            ...
            <p class="#"><a href="<?php echo base_url();?>/assets/template/CustomerTemplate.csv" download>Click Here</a></p>
        </div>
    ...
    <div class="fileimport">
        ...
        <form method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/users/customerimportcsv">
            ...
            foreach($records as $keys=>$vals){
              $status = ($vals['is_active'] == 1)?'Active': 'In Active';
                echo  '<tr role="row" class="odd">
                        ...
                        <td class="sorting_1 statusletter">'.$vals['mobile_no'].'</td>
                        <td class="sorting_1 statusletter">'.$status.'</td>
                        <td>
                          <a title="Edit" 
                               class="btn-edit" href="'.base_url().'admin/users/edit/'.$vals['id'].'"> Edit
                          </a>
                        <a title="Delete" 
                          class="btn-edit" href="'.base_url().'admin/users/delete/'.$vals['id'].'"> Delete
                        </a>
