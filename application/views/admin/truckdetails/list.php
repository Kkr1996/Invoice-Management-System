  ...
  <div class="card">
    <div class="card-header">
        ...
        <div class="box-tools pull-right">
            <a href="<?= base_url('admin/truckdetails/add'); ?>" class="btn btn-primary btn-sm">ADD NEW</a>
        </div>
    </div>
     <div class="card-body">
      ...
      <div class="fileimport">
            <div class="form-group">
                ...
                <p class="#"><a href="<?php echo base_url();?>/assets/template/TruckingList.csv" download>Click Here</a></p>
            </div>
        ...
        <div class="fileimport">
            ...
            <form method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/truckdetails/importcsv">
        ...
        <tr>
          ...
          <th>Action</th>
            ...
            echo '<tr role="row" class="odd">
               ...
               <td class="sorting_1">'.$vals['truck_number'].'</td>
  
               <td>
                <a title="Edit" 
                    class="btn-edit" href="'.base_url().'admin/truckdetails/edit/'.$vals['id'].'"> Edit
                </a>
                <a title="Delete" 
                   class="btn-delete" href="'.base_url().'admin/truckdetails/del/'.$vals['id'].'" 
