  ...
  <div class="card">
    <div class="card-header">
        ...
        <div class="box-tools pull-right">
            <a href="<?= base_url('admin/job/add'); ?>" class="btn btn-primary btn-sm">ADD NEW</a>
        </div>
    </div>
     <div class="card-body">
      ...
      <div class="fileimport">
            <div class="form-group">
                ...
                <p class="#"><a href="<?php echo base_url();?>/assets/template/JobTemplate.csv" download>Click Here</a></p>
            </div>
        ...
        <div class="fileimport">
            ...
            <form method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/job/jobimportcsv">
        ...
        <tr>
          ...
          <th>Action</th>
            ...
            foreach($records as $keys=>$vals){
              ...
              $query = $this->db->get_where('ci_company', array('company_id' => $company_id));
              $c_name = $query->row_array()['company_name'];
            ...
            echo '<tr role="row" class="odd">
               <td>'.++$keys.'</td>
               <td><a href="'.base_url().'/admin/manifest/allmanifesto/'.$vals['jobid'].'">'.$vals['jobid'].'</a></td>
               <td class="sorting_1">'.$c_name.'</td>
               <td class="sorting_1">'.$vals['name'].'</td>
               <td class="sorting_1">'.$vals['price'].'</td>
               <td class="sorting_1">'.$vals['details'].'</td>
               
               <td class="sorting_1 statusletter">'.$vals['status'].'</td>
               <td>
                <a title="Edit" 
                    class="btn-edit" href="'.base_url().'admin/job/edit/'.$vals['id'].'"> Edit
                </a>
                <a title="Delete" 
                   class="btn-delete" href="'.base_url().'admin/job/del/'.$vals['id'].'" 
                   onclick="return confirm("Do you want to delete ?")"> Delete
                </a>

                <a title="PDF" 
                    class="btn-view" href="'.base_url().'admin/job/view/'.$vals['id'].'"> Pdf
                </a>
