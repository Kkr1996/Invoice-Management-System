        ...
        <div class="llp-hed-par">
            <div class="hed-box hed-one wow slideInLeft data-wow-duration="4s" data-wow-delay="0.4s"">
             ...
             <div class="hed-box hed-two wow slideInDown data-wow-duration="4s" data-wow-delay="0.4s"">
                <h2>Profesional Tax Registeration</h2>
                <div class="ser-stars">
...
<section id="why-choose-us">
    ...
    <section class="ser-fixed-hed-menu">
        <nav class="nav">
            <ul>
                <li class="active"><a class="nav-link" href="#price">Pricing</a></li>       
    ...
    <section class="section intro active" id="price">
        <div class="wrapper">
    ...
    <section class="section contact" id="beni">
    ...
    <section class="section contact" id="docs">
            <div class="overview-par-div">
                <div class="over-img">
    ...
    <section class="section contact wow slideInLeft data-wow-duration="5s" data-wow-delay="0.5s"" id="faq">
